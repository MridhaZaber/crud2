        ...
        <div class="col-md-6 col-md-offset-3">
            <?php if(isset($_SESSION['error_msg'])){
                ...
                <div class="alert alert-warning">
                    <strong>Waring</strong><?php echo $_SESSION['error_msg'];?>
                </div>
                <?php
            }
            ?>
            ...
            <?php if(isset($_SESSION['error_msg1'])){
                ?>
                <div class="alert alert-warning">
                    <strong>Waring</strong><?php echo $_SESSION['error_msg1'];?>
                </div>
                <?php
            }
            ?>
            ...
            <form action="confirmRegistration.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input required type="password" class="form-control" name="confirm_password" placeholder="ConfirmPASSWORD">
                </div>
